...
class FlowerForm(FlaskForm):
    ...
    petal_len = StringField("Petal Length")
    petal_wid = StringField("Petal Width")
...
def index():
    ...
    if form.validate_on_submit():
        ...
        session['petal_len'] = form.petal_len.data
        session['petal_wid'] = form.petal_wid.data
...
def prediction():
    ...
    content['petal_length'] = float(session['petal_len'])
    content['petal_width'] = float(session['petal_wid'])
